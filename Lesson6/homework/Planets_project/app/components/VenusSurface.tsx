...
function VenusSurface({setActiveComponent}:overviewProps) {
  return (
    <div className=' flex flex-col justify-center items-center'>
      ...
      <div className='flex flex-col justify-center items-center mt-[95px] md:mt-[146px] lg:flex-row lg:gap-[300px] lg:mt-[60]'>
        {/* img div */}
        <div  className='relative  mt-[74px] w-[154px] h-[154px] md:h-[184px] md:w-[184px] md:mt-[112px] lg:w-[290px] lg:h-[290px] lg:mt-[0]'>
          <Image className='object-cover md:w-[184px] lg:w-[290px] lg:h-[290px]' src="/venus.svg" alt="venusimg" width={154} height={154} />
          <Image className='absolute top-[75%] lg:top-[65%] translate-x-1/2 md:w-[92px] lg:w-[145px] lg:h-[290px]' src="/venusAddImg.svg" alt="venusCneterImg" width={77.5} height={154} />
        </div>
