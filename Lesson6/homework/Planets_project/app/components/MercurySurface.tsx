...
function MercurySurface({setActiveComponent}:overviewProps) {
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <div className='flex flex-col justify-center items-center mt-[95px] md:mt-[146px] lg:flex-row lg:gap-[300px] lg:mt-[50]'>
        ...
        <div className='relative mt-[95px] md:mt-[146px] lg:w-[290px] lg:h-[290px] lg:mt-[0]'>
          ...
          <Image className='absolute top-[75%] lg:top-[60%] translate-x-1/2 md:w-[80px] md:h-[80px] lg:w-[145px] lg:h-[290px]' src="/mercurySurface.svg" width={80} height={80} alt="surfaceImgg" />
        </div>
        ...
        <div className='md:flex md:justify-center md:items-center md:mt-[50px] md:gap-[80px] lg:flex-col lg:gap-[39px]'>
          {/* text */}
          <div className='mt-[98px]  md:mt-[0] md:mx-[0] flex flex-col justify-center items-center mx-[24px] md:justify-self-start md:items-start md:w-[340px] '>
            ...
            <p className='text-[11px] text-center mt-[16px] planetDescr md:text-left md:leading-[22px] md:text-[12px] md:mt-[24px] lg:text-[14px] lg:leading-[25px]'>
              Mercurys surface is similar in appearance to that of the Moon, showing extensive mare-like plains and heavy cratering, indicating that it has been geologically inactive for billions of years. It is more heterogeneous than either Marss or the Moon’s.
            </p>
      ...
      <div className="mx-[24px] mt-[28px] mb-[47px] md:flex md:justify-center md:items-center md:mt-[27px] md:gap-[13px] lg:mt-[87px] lg:gap[30px]"> {/* mother div */}
        {
          additionalInfoMercury.map((item) => {
            return <div key={item.id} className='cursor-pointer w-[327px] first:mt-[0px] rounded-[1px] border border-[#edededd2]  flex justify-between items-center mt-[8px] px-[24px] pt-[9px] pb-[13px] md:w-[164px] md:h-[88px] md:mt-[0] md:flex-col md:justify-center md:gap-[6px] md:place-items-start lg:gap-[4px] lg:w-[255px]'>
