...
function EarthStructure({setActiveComponent}:overviewProps) {
  return (
    <div className=' flex flex-col justify-center items-center'>
      
      {/* contet div */}
      <div className='flex flex-col justify-center items-center mt-[95px] md:mt-[146px] lg:flex-row lg:gap-[300px] lg:mt-[60]'>
        {/* images div  */}
        <div className='relative mt-[64px] w-[173px] h-[173px]  md:mt-[112px] md:w-[184px] md:h-[184px] lg:w-[290px] lg:h-[290px] lg:mt-[0]'>
          <Image className='object-cover md:mt-[0] md:w-[184px] md:h-[184px] lg:w-[290px] lg:h-[290px]'   src="/earth.svg" alt="earthImg" width={173} height={173} />
          <Image className='absolute top-0 left-[75%] -translate-x-1/2 md:w-[92px] lg:w-[145px] lg:h-[290px]' src="/earthHalf.svg" alt="halfEarth" height={173} width={86.5} />
        </div>
        ...
        <div className='md:flex md:justify-center md:items-center md:mt-[50px] md:gap-[80px]  lg:flex-col lg:gap-[39px]'>
          ...
          <div className='mt-[76px] mx-[24px] flex flex-col justify-center items-center  md:mt-[0]  md:mx-[0]  md:justify-self-start md:items-start md:w-[340px]'>
            ...
            <p className=' text-center font-[400] text-[11px]   mt-[16px] planetDescr md:text-left md:leading-[22px] md:text-[12px] md:mt-[24px] lg:text-[14px] lg:leading-[25px]'>
              Earths interior, like that of the other terrestrial planets, is divided into layers by their chemical or physical (rheological) properties. The outer layer is a chemically distinct silicate solid crust, which is underlain by a highly viscous solid mantle.
            </p>
